...
public class IndividualPaperDetails extends AppCompatActivity {
    ...
    private SentenceMinimizer minimizer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Sentence minimization
        minimizer = new SentenceMinimizer();
        minimizer.setPara(Content);
        ...
        content.setText(Html.fromHtml(minimizer.getPara()));
